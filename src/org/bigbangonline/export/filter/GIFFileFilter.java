...
/**
 * The Class GIFFileFilter.
 */
public class GIFFileFilter extends javax.swing.filechooser.FileFilter{
	...
	public boolean accept(java.io.File f){
		...
		String extension =GIFUtils.getExtension(f);

		//If the extension exists
		if(extension!=null){

			//If the extension is ".ps", then show it
			if(extension.equals(GIFUtils.gif)){
