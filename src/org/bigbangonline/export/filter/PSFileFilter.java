...
/**
 * The Class PSFileFilter.
 */
public class PSFileFilter extends javax.swing.filechooser.FileFilter{
	...
	public boolean accept(java.io.File f){
		...
		String extension = PSUtils.getExtension(f);

		//If the extension exists
		if(extension!=null){

			//If the extension is ".ps", then show it
			if(extension.equals(PSUtils.ps)){
