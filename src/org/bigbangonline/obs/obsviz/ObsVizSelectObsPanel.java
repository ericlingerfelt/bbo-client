...
/**
 * The Class ObsVizSelectObsPanel.
 */
public class ObsVizSelectObsPanel extends JPanel implements ActionListener{
	...
	/**
	 * Instantiates a new obs viz select obs panel.
	 *
	 * @param mds the mds
	 * @param ds the ds
	 ...
	 */
	public ObsVizSelectObsPanel(MainDataStructure mds, ObsVizDataStructure ds, CGICom cgiCom, ObsVizFrame frame){
		...
		JLabel topLabel = new JLabel("<html>Select observations for visualization by highlighting an observation from the tree"
											+ " and clicking<p><i>Add Selected Observation</i>. Remove one or more observations"
											+ " from the selection list by highlighting<p>the observations and clicking <i>Remove</i>"
