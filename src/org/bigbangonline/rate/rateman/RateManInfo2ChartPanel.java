...
/**
 * The Class RateManInfo2ChartPanel.
 */
public class RateManInfo2ChartPanel extends JPanel implements ActionListener, ItemListener{
	...
	/**
	 * Instantiates a new rate man info2 chart panel.
	 *
	 * @param mds the mds
	 * @param ds the ds
	 ...
	 */
	public RateManInfo2ChartPanel(MainDataStructure mds, RateManDataStructure ds, CGICom cgiCom, RateManFrame frame){
